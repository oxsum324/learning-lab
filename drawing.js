import {SHEETS,COLORS,emptyWorkspace,toWorkspace,changeLayout,validDrawing,shape,moveShape,makeTemplate} from './drawing-model.js?v=0.11.0';
import {LAYOUTS,lessonLayout} from './drawing-layouts.js?v=0.11.0';
