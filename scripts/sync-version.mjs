...
const files=['site/index.html','site/app.js','site/core.js','site/drawing.js','site/drawing-model.js','site/drawing-layouts.js','site/teaching-guides.js','site/topics.js'];
let changes=0;
