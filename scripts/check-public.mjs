...
walk(fileURLToPath(root));const data=JSON.parse(readFileSync(new URL('curriculum.json',root),'utf8'));if(data.days.length!==30||data.days.some((d,i)=>d.day!==i+1||!d.problem||!d.task||!d.check))throw Error('Invalid curriculum');console.log('Public content checked; 30 complete lesson entries.');
