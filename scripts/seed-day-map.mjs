export const SEED_DAY_MAP={
 ...
 'steel-structures':{
  1:{questions:[],fields:[]},2:{questions:['st_c02'],fields:['st_c02']},3:{questions:['st_c03'],fields:['st_c03']},4:{questions:['st_c04'],fields:['st_c04']},5:{questions:['st_c05'],fields:['st_c05']},6:{questions:['st_c06'],fields:['st_c06']},7:{questions:['st_w07a','st_w07b'],fields:['st_w07a','st_w07b']},11:{questions:['st_c07'],fields:['st_c07']},14:{questions:['st_c07','st_w23b'],fields:['st_c07','st_w23b']},23:{questions:['st_w23a','st_w14b'],fields:['st_w23a','st_w14b']}
 },
 'structural-dynamics':{
